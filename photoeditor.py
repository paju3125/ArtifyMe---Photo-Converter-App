...
image = Image.open(r'./cat.jpg') #Brand logo image (optional)
...
filter = st.sidebar.radio('Covert your photo to: ' + str(np.random.randint(100)), ['Original','Gray Image', 'Black and White', 'Pencil Sketch', 'Blur Effect'])
